...
//import { MantenimientoIeComponent } from './sistema/gestion-institucional/mantenimiento/mantenimiento-ie/mantenimiento-ie.component'
  ...
  { path: 'inicio', component: InicioComponent },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './sistema/gestion-institucional/mantenimiento/mantenimiento-ie/mantenimiento-ie.component'
          ).then(m => m.MantenimientoIeComponent),
      },
      {
