...
export class DetalleMatriculasService {
  ...
  guardarConclusionDescriptiva(
    ...
    params: {
      ...
      bEsPorPeriodo: boolean;
      iNumeroPeriodo: number | null;
      iEscalaCalifIdPeriodo: number | string;
      cDetMatrConclusionDescPeriodo: string;
      iCredId: string | number;
    }
  ): Observable<any> {
    return this.http.put<any>(`${baseUrl}/acad/detalle-matriculas/${iDetMatrId}`, params);
  }
}
