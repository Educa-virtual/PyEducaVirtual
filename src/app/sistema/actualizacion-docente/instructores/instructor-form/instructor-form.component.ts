...
export class InstructorFormComponent implements OnChanges, OnInit {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (this.action === 'editar') {
      ...
      this.instructorForm.get('iTipoIdentId').disable();
      this.instructorForm.get('cPersDocumento').disable();
      this.instructorForm.get('cPersNombre').disable();
      this.instructorForm.get('cPersPaterno').disable();
      this.instructorForm.get('cPersMaterno').disable();
    } else {
