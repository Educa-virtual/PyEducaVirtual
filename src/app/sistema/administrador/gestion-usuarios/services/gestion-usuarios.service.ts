...
export class GestionUsuariosService {
  ...
  obtenerPerfilesUsuario(iCredId: any) {
    return this.http.get(`${this.urlBackendApi}/seg/usuarios/${iCredId}/perfiles`);
  }

  cambiarEstadoUsuario(iCredId: number, activo: string) {
    return this.http.patch(`${this.urlBackendApi}/seg/usuarios/${iCredId}/estado`, {
      iCredEstado: activo,
    });
  }

  restablecerClaveUsuario(iCredId: number) {
    return this.http.patch(`${this.urlBackendApi}/seg/usuarios/${iCredId}/password`, null);
  }
  ...
  obtenerInstitucionesEducativas() {
    return this.http.get(`${this.urlBackendApi}/acad/instituciones-educativas`);
  }

  obtenerModulosAdministrativos() {
    return this.http.get(`${this.urlBackendApi}/seg/modulos-administrativos`);
  }
  ...
  registrarPerfil(iCredId: number, data: any) {
    return this.http.post(`${this.urlBackendApi}/seg/usuarios/${iCredId}/perfiles`, data);
  }

  obtenerSedesInstitucionEducativa(iIieeId: number) {
    return this.http.get(`${this.urlBackendApi}/acad/instituciones-educativas/${iIieeId}/sedes`);
  }
  ...
  actualizarFechaVigencia(iCredId: number, dtCredCaduca: Date) {
    return this.http.patch(`${this.urlBackendApi}/seg/usuarios/${iCredId}/fecha-vigencia`, {
