...
export class ApiAulaBancoPreguntasService {
  ...
  obtenerTipoPreguntas(params?) {
    return this._http
      .get(`${this.baseUrlApi}/evaluaciones/tipo-preguntas/obtenerTipoPreguntas`, { params })
      .pipe(map(resp => resp['data']));
  }

  obtenerBancoPreguntas(params): Observable<any> {
    return this._http.get(`${this.baseUrlApi}/evaluaciones/banco-preguntas/obtenerBancoPreguntas`, {
      params,
    });
  }
  // encabezados
  obtenerEncabezadosPreguntas(params) {
    return this._http
      .get(`${this.baseUrlApi}/evaluaciones/banco-preguntas/obtenerEncabezadosPreguntas`, {
        params,
      })
      .pipe(
        map(resp => resp['data']),
