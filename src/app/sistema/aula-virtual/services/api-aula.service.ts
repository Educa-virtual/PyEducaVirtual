...
export class ApiAulaService {
  ...
  // Foros
  guardarForo(data) {
    return this._http.post(`${this.baseUrlApi}/aula-virtual/contenidos/foro/guardarForo`, data);
  }
  actualizarForo(data) {
    return this._http.post(`${this.baseUrlApi}/aula-virtual/foros/actualizarForo`, data);
  }
  ...
  obtenerRespuestaForo(params: { iActTipoId; ixActivadadId }) {
    return this._http
      .get<any>(`${this.baseUrlApi}/aula-virtual/contenidos/foro/obtenerRespuestaForo`, { params })
      .pipe(
        map(resp => resp.data),
        map(data => {
          if (data.iActTipoId == 2) {
  ...
  obtenerResptDocente(params: { iEstudianteId; iForoId }) {
    return this._http.get(`${this.baseUrlApi}/aula-virtual/contenidos/foro/obtenerReptdocente`, {
      params,
    });
    // .pipe(
    //     map((response) => {
  ...
  guardarCalificacionEstudiante(esquema: string, tabla: string, where: any, datos: any) {
    return this._http
      .post<any>(`${this.baseUrlApi}/aula-virtual/Resultado/guardarCalfcEstudiante`, {
        esquema,
        tabla,
        where,
        datos,
  ...
  obtenerActividad(params: { iActTipoId; ixActivadadId }) {
    return this._http
      .get<any>(`${this.baseUrlApi}/aula-virtual/contenidos/actividad/obtenerActividad`, { params })
      .pipe(
        map(resp => resp.data)
        // map((data) => {
  ...
  habilitarCalificacion(data) {
    return this._http.post(`${this.baseUrlApi}/aula-virtual/Resultado/habilitarCalificacion`, data);
    // .pipe(
    //     map((resp) => {
  ...
  obtenerReporteFinalDeNotas(params: {
    ...
    return this._http.get(`${this.baseUrlApi}/aula-virtual/Resultado/obtenerReporteFinalNotas`, {
      params,
    });
    //.pipe(map((resp) => resp.data))
  }
  ...
  generarReporteDeLogroFinalDeYear(params: { iSedeId }) {
    return this._http.get(`${this.baseUrlApi}/aula-virtual/Resultado/reporteDeLogroFinalXYear`, {
      params, // Enviar los datos como parámetros
    });
  }
  ...
  actualizarReunionVirtual(data, ruta) {
    return this._http.put(`${this.baseUrlApi}/aula-virtual/reunion-virtuales/${ruta}`, data);
  }

  EliminarReunionVirtual(data) {
    return this._http.delete(`${this.baseUrlApi}/aula-virtual/reunion-virtuales`, data);
  }
}
