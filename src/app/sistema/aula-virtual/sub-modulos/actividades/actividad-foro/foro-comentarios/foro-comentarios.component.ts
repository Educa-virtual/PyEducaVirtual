...
@Component({
  ...
  imports: [PrimengModule, RemoveHTMLPipe, ForoEstudiantesComponent, NoDataComponent],
})
export class ForoComentariosComponent implements OnInit {
  ...
  iDocenteId: number;
  iEstadoForo: number | string = 0; // Estado del foro, 0: cerrado, 1: abierto
  ...
  ngOnInit() {
    ...
    this.getRespuestaF();
    this.iEstadoForo = this.dataForo.iEstado;
    console.log('datos de foro', this.iEstadoForo);
  }
