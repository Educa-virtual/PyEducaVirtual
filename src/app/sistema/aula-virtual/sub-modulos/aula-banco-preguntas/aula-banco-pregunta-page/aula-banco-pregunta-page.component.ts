...
export class AulaBancoPreguntaPageComponent implements OnInit {
  ...
  eliminarBancoPreguntas(iBancoId) {
    ...
    this._BancoPreguntasService.eliminarBancoPreguntasxiBancoId(iBancoId, params).subscribe({
      next: resp => {
        if (resp.validated) {
          this.mostrarMensajeToast({
            severity: 'success',
  ...
  eliminarEncabezadoPreguntas(idEncabPregId) {
    ...
    this._EncabezadoPreguntasService
      .eliminarBancoEncabezadoPreguntasxidEncabPregId(idEncabPregId, params)
      .subscribe({
        next: resp => {
          if (resp.validated) {
            this.mostrarMensajeToast({
