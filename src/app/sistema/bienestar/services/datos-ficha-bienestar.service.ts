...
export class DatosFichaBienestarService implements OnDestroy {
  ...
  listarEstudiantesApoderado(data: any) {
    return this.http.post(`${baseUrl}/bienestar/listarEstudiantesApoderado`, data);
  }
  ...
  actualizarFichaGeneral(data: any) {
    return this.http.post(`${baseUrl}/bienestar/actualizarFichaGeneral`, data);
  }
  ...
  guardarFichaEconomico(data: any) {
    return this.http.post(`${baseUrl}/bienestar/guardarFichaEconomico`, data);
  }

  actualizarFichaEconomico(data: any) {
    return this.http.post(`${baseUrl}/bienestar/actualizarFichaEconomico`, data);
  }
  ...
  actualizarFamiliar(data: any) {
    return this.http.post(`${baseUrl}/bienestar/actualizarFichaFamiliar`, data);
  }
  ...
  listarFamiliares(data: any) {
    return this.http.post(`${baseUrl}/bienestar/listarFichaFamiliares`, data);
  }
  ...
  actualizarFichaVivienda(data: any) {
    return this.http.post(`${baseUrl}/bienestar/actualizarFichaVivienda`, data);
  }
  ...
  guardarFichaAlimentacion(data: any) {
    return this.http.post(`${baseUrl}/bienestar/guardarFichaAlimentacion`, data);
  }

  actualizarFichaAlimentacion(data: any) {
    return this.http.post(`${baseUrl}/bienestar/actualizarFichaAlimentacion`, data);
  }
  ...
  guardarFichaRecreacion(data: any) {
    return this.http.post(`${baseUrl}/bienestar/guardarFichaRecreacion`, data);
  }

  actualizarFichaRecreacion(data: any) {
    return this.http.post(`${baseUrl}/bienestar/actualizarFichaRecreacion`, data);
  }
  ...
  guardarFichaDiscapacidad(data: any) {
    return this.http.post(`${baseUrl}/bienestar/guardarFichaDiscapacidad`, data);
  }
  ...
  getFichaParametros() {
    if (!this.parametros) {
      return this.http.get(`${baseUrl}/bienestar/obtenerParametrosFicha`).pipe(
        map((data: any) => {
  ...
  getLenguas(data: any) {
    if (!this.lenguas && data) {
      const items = JSON.parse(data.replace(/^"(.*)"$/, '$1'));
      this.lenguas = items.map(lengua => ({
        value: lengua.iLenguaId,
        label: lengua.cLenguaNombre,
      }));
      return this.lenguas;
    }
    return this.lenguas;
  ...
  getEtnias(data: any) {
    if (!this.etnias && data) {
      const items = JSON.parse(data.replace(/^"(.*)"$/, '$1'));
      this.etnias = items.map(etnia => ({
        value: etnia.iEtniaId,
        label: etnia.cEtniaNombre,
      }));
      return this.etnias;
    }
    return this.etnias;
  ...
  getTiposDocumentos(data: any) {
    if (!this.tipos_documentos && data) {
      ...
      this.tipos_documentos = items.map(documento => ({
        ...
        label: documento.cTipoIdentSigla + ' - ' + documento.cTipoIdentNombre,
  ...
  subirArchivo(data: any) {
    return this.http.post(`${baseUrl}/acad/estudiante/importarEstudiantesPadresExcel`, data, {
