...
export class DatosSeguimientoBienestarService implements OnDestroy {
    ...
    verSeguimientosPersona(data: any) {
        return this.http.post(
            `${baseUrl}/bienestar/verSeguimientosPersona`,
            data
        )
    }
    ...
    actualizarSeguimiento(data: any) {
        return this.http.post(
            `${baseUrl}/bienestar/actualizarSeguimiento`,
            data
        )
    }
    ...
    getSeguimientoParametros(data: any) {
        if (!this.parametros) {
            this.parametros = this.http
                .post(`${baseUrl}/bienestar/crearSeguimiento`, data)
                .pipe(
                    map((data: any) => {
    ...
    filterInstitucionesEducativas(iNivel: any): Observable<any[]> {
        return of(this.sedes).pipe(
            map((sedes) => sedes.filter((sede: any) => sede.iNivel === iNivel))
        )
    }
