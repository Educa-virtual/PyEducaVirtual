...
export class BuzonDirectorComponent implements OnInit {
  ...
  dataSugerencias = [
    ...
    },
    {
      ...
      cSugerencia: 'Hay un solapamiento en los horarios de física y química para el grupo A.',
    },
    {
      item: 3,
      iSugerenciaId: 3,
    ...
    },
    {
      ...
      cRespuesta: '13/05/2025',
      cSugerencia: 'Sería bueno incluir opciones vegetarianas en el menú de la cafetería.',
    },
    {
      item: 5,
      iSugerenciaId: 5,
      ...
      cRespuesta: '',
      cSugerencia: 'La plataforma virtual se cae frecuentemente durante las horas pico.',
    },
  ];
  ...
  ngOnInit() {
    ...
    this.breadCrumbItems = [{ label: 'Administración' }, { label: 'Buzón de sugerencias' }];
  }
    ...
    if (event == true) {
      ...
      if (this.selectedItem) {
        ...
        const index = this.dataSugerencias.findIndex(
          item => item.iSugerenciaId === this.selectedItem.iSugerenciaId
        );
        if (index !== -1) {
