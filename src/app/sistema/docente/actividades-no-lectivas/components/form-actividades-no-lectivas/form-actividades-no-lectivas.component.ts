...
@Component({
  ...
  standalone: true,
  imports: [ModalPrimengComponent, PrimengModule, TypesFilesUploadPrimengComponent, NgIf],
...
export class FormActividadesNoLectivasComponent implements OnChanges {
  ...
  ngOnChanges(changes) {
    ...
    if (changes.tiposCargaNoLectivas?.currentValue) {
      this.tiposCargaNoLectivas = changes.tiposCargaNoLectivas.currentValue;
    }
    ...
    if (changes.opcion?.currentValue) {
      ...
      this.formDetalleCargaNoLectivas =
        this.opcion === 'GUARDAR' ? storeDetalleCargaNoLectivas : updateDetalleCargaNoLectivas;
    }
    if (changes.data?.currentValue) {
      ...
      if (this.formDetalleCargaNoLectivas) {
        ...
        this.formDetalleCargaNoLectivas.controls['opcion'].setValue(this.opcion);
        const files = this.formDetalleCargaNoLectivas.value.cDetCargaNoLectEvidencias;
  ...
  accionBtn(elemento): void {
    ...
    switch (accion) {
      case 'close-modal':
        ...
        break;
      case this.opcion:
        this.formDetalleCargaNoLectivas.controls['cDetCargaNoLectEvidencias'].setValue(
