...
export class PerfilComponent implements OnInit {
  ...
  @Input() fotoParent: string = '';
  @Output() fotoParentChange = new EventEmitter<string>();
  ...
  actualizarRutaFotoPerfil(foto: string) {
    this.formPersonas.get('cPersFotografia')?.setValue(this.backend + '/' + foto);
    this.fotoParent = this.backend + '/' + foto;
    const user = this._LocalStoreService.getItem('dremoUser');
    user.cPersFotografia = foto;
    this._LocalStoreService.setItem('dremoUser', user);
    this.fotoParentChange.emit(this.backend + '/' + foto);
  }
