...
export class SilaboComponent implements OnInit, OnDestroy {
  ...
  initDescripcion: EditorComponent['init'] = {
    ...
    selector: 'textarea',
    setup: editor => {
      editor.on('blur', e => this.actualizar(e, 'cSilaboDescripcionCurso'));
    },
  ...
  silabo = [
    ...
    {
      iSilabo: 4,
      cSilaboTitle: 'Desarrollo de Actividades de Aprendizaje y de Evaluación',
      icon: 'pi-clipboard',
    },
  ...
  ngOnInit() {
    ...
    this.cambiar = this.nivelTipo == '3' || this.nivelTipo == '4' ? true : false;

    if (this.cambiar) {
      this.silabo[1]['cSilaboTitle'] = 'Área Curricular, Capacidad y Metodología';
    }
  }
  actualizar(data: any, index: string) {
    const json_update: any = {};
    json_update['iSilaboId'] = this.dataSilabo.controls.iSilaboId.getRawValue();
    ...
    switch (index) {
      case 0:
        ...
        if (api) {
          ...
          this.dataSilabo.controls.iSilaboId.setValue(this.dataInformation[0]?.iSilaboId);
        }
        break;
      case 1:
        // CONSULTARxidDocCursoIdxiSemAcadIdxiYAcadId => 1
        this.dataSilabo.controls.opcion.setValue('1');
        this.dataSilabo.controls.idDocCursoId.setValue(this.idDocCursoId);
        this.dataSilabo.controls.iSemAcadId.setValue(null);
        this.dataSilabo.controls.iYAcadId.setValue(this.ConstantesService.iYAcadId);
        ...
        api ? this.getInformation(index, params) : this.dataSilabo.patchValue(data[0]);
        break;
      case 2:
        break;
      case 3:
      ...
      case 'tipo_metodologias':
        ...
        api ? this.getInformation(index, params) : (this.tipoMetodologias = data);
        break;
      default:
        break;
    }
