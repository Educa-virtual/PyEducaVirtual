...
export class AccesosEncuestaComponent implements OnInit, OnChanges {
  ...
  actualizarAccesos() {
    this.encuestasService.actualizarEncuesta(this.form.value).subscribe({
      next: (resp: any) => {
        this.encuesta.iEspDremoTipoAccesoId = this.form.get('iEspDremoTipoAccesoId')?.value;
        this.encuesta.iEspUgelTipoAccesoId = this.form.get('iEspUgelTipoAccesoId')?.value;
        this.encuesta.iDirectorTipoAccesoId = this.form.get('iDirectorTipoAccesoId')?.value;
