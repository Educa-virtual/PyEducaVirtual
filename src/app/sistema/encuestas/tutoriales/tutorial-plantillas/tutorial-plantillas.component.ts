...
@Component({
  selector: 'app-tutorial-plantillas',
  standalone: true,
  imports: [PrimengModule],
  templateUrl: './tutorial-plantillas.component.html',
  styleUrl: './tutorial-plantillas.component.scss',
})
export class TutorialPlantillasComponent implements OnInit {
