...
export class ApiEvaluacionesRService {
  ...
  obtenerEvaluacion(params) {
    return this.http
      .get(`${this.urlBackendApi}/ere/Evaluaciones/ereObtenerEvaluacion`, {
        params,
      })
      .pipe(
        tap(response => console.log('Respuesta de la API:', response)), // Verifica lo que devuelve la API
        catchError(error => {
  ...
  obtenerTipoPreguntas() {
    return this.http
      .get(`${this.urlBackendApi}/evaluaciones/tipo-preguntas/obtenerTipoPreguntas`)
      .pipe(map(resp => resp['data']));
  }
  ...
  obtenerNivelTipo(params) {
    return this.http.get(`${this.urlBackendApi}/ere/nivelTipo/obtenerNivelTipo`, {
      params,
    });
  }
  //Tengo estos cursos en el backend
  obtenerCursos(params) {
    return this.http.post(`${this.urlBackendApi}/ere/Evaluaciones/obtenerCursos`, {
      params,
    });
  }
  ...
  insertarCursos(data: {
    ...
    return this.http.post(`${this.urlBackendApi}/ere/Evaluaciones/insertarCursos`, data);
  }
  eliminarCursos(data: {
    iEvaluacionId: number;
    selectedCursos: { iCursoNivelGradId: number }[];
  }): Observable<any> {
    return this.http.delete(`${this.urlBackendApi}/ere/Evaluaciones/eliminarCursos`, {
      body: data,
    });
  }
  ...
  obtenerEvaluacionesCopia(params) {
    return this.http.get(`${this.urlBackendApi}/ere/Evaluaciones/obtenerEvaluacionCopia2`, {
      params,
    });
  }
  obtenerTipoEvaluacion(params) {
    return this.http.get(`${this.urlBackendApi}/ere/tipoEvaluacion/obtenerTipoEvaluacion`, {
      params,
    });
  }
  obtenerNivelEvaluacion(params) {
    return this.http.get(`${this.urlBackendApi}/ere/nivelEvaluacion/obtenerNivelEvaluacion`, {
      params,
    });
  }
  // insert_Code_New
  guardarEvaluacion(data: any) {
    return this.http.post(`${this.urlBackendApi}/ere/Evaluaciones/guardar`, data);
  }
  ...
  guardarParticipacion(data) {
    return this.http.post(`${this.urlBackendApi}/ere/Evaluaciones/guardarParticipacion`, data);
  }
  ...
  IEparticipanall(data) {
    return this.http.post(`${this.urlBackendApi}/ere/Evaluaciones/IEparticipanall`, data);
  }
  //Actualizar Cursos
  actualizarCursos(
    iEvaluacionId: number,
    ...
    return this.http.put(`${this.urlBackendApi}/ere/Evaluaciones/actualizarCursos`, data);
  }
  //!Agregando Copiar ActualizarEvaluacion
  copiarEvaluacion(iEvaluacionId: number) {
    return this.http.post(`${this.urlBackendApi}/ere/Evaluaciones/copiarEvaluacion`, {
      iEvaluacionIdOriginal: iEvaluacionId,
    });
  }
  //!MatrizCompetencias
  obtenerMatrizCompetencias(params) {
    return this.http.get(`${this.urlBackendApi}/ere/Evaluaciones/obtenerMatrizCompetencias`, {
      params,
    });
  }
  //!Matriz Capacidades
  obtenerMatrizCapacidades(params) {
    return this.http.get(`${this.urlBackendApi}/ere/Evaluaciones/obtenerMatrizCapacidades`, {
      params,
    });
  }
  //!Matriz Desempeno
  ...
  generarPdfMatrizbyEvaluacionId(baseParams): Observable<any> {
    ...
    return this.http.get(`${this.urlBackendApi}/ere/Evaluaciones/generarPdfMatrizbyEvaluacionId`, {
      params: {
        ...baseParams,
      },
  ...
  //     )
  // }
  obtenerEspDremCurso(iPersId: number, iEvaluacionId: number): Observable<any> {
    const params = { iPersId, iEvaluacionId }; // Enviar el iPersId como parámetro
    //console.log('Parámetros enviados al backend:', params)
    return this.http.get(`${this.urlBackendApi}/ere/Evaluaciones/obtenerEspDremCurso`, { params });
  }
  //!
  ...
  obtenerConteoPorCurso(data) {
    return this.http.post(`${this.urlBackendApi}/ere/Evaluaciones/obtenerConteoPorCurso`, data);
  }
  //!
  ...
  obtenerPreguntaSeleccionada(iEvaluacionId: number) {
    return this.http.get(`${this.urlBackendApi}/ere/Evaluaciones/obtenerPreguntaSeleccionada`, {
      params: {
  ...
  obtenerPreguntaInformacion(iEvaluacionId: number) {
    return this.http.get(`${this.urlBackendApi}/ere/Evaluaciones/obtenerPreguntaInformacion`, {
      params: {
        iEvaluacionId: iEvaluacionId.toString(), // Convertir a cadena si es necesario
  ...
  eliminarPreguntaById(id) {
    return this.http.delete(`${this.urlBackendApi}/ere/preguntas/eliminarBancoPreguntasById/${id}`);
  }

  actualizarBancoPreguntas(data) {
    return this.http.patch(`${this.urlBackendApi}/ere/preguntas/actualizarBancoPreguntas`, data);
  }
  ...
  eliminarAlternativaById(id) {
    return this.http.delete(`${this.urlBackendApi}/ere/alternativas/eliminarAlternativaById/${id}`);
  }

  obtenerAlternativaByPreguntaId(id) {
    return this.http
      .get(`${this.urlBackendApi}/ere/alternativas/obtenerAlternativaByPreguntaId/${id}`)
      .pipe(map(resp => resp['data']));
  }
  eliminarPregunta(iEvaluacionId: number, iPreguntaId: number): Observable<any> {
    return this.http.delete(`${this.urlBackendApi}/ere/Evaluaciones/eliminarPregunta`, {
  ...
  obtenerEncabezadosPreguntas(params) {
    return this.http
      .get(`${this.urlBackendApi}/ere/preguntas/obtenerEncabezadosPreguntas`, {
        params,
      })
      .pipe(map(resp => resp['data']));
  }
  ...
  actualizarMatrizPreguntas(data) {
    return this.http.patch(`${this.urlBackendApi}/ere/preguntas/actualizarMatrizPreguntas`, data);
  }
  ...
  obtenerCapacidades(params) {
    return this.http.get(`${this.urlBackendApi}/ere/capacidades/obtenerCapacidades`, { params });
  }
  ...
  descargarCartillaRespuestas(params) {
    return this.http.post(`${this.urlBackendApi}/ere/Evaluaciones/obtenerHojaRespuestas`, params, {
      responseType: 'blob',
    });
  }
