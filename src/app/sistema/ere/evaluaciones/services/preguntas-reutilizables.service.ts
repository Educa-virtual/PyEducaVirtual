...
export class PreguntasReutilizablesService {
  ...
  obtenerPreguntas(iEvaluacionId, iCursosNivelGradId, params: HttpParams): Observable<any> {
    return this.http
      .get(
  ...
  registrarPreguntasEnEvaluacion(iEvaluacionId, iCursosNivelGradId, preguntas) {
