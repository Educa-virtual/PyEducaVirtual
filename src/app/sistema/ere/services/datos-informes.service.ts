...
export class DatosInformesService {
  ...
  obtenerInformeResumen(data: any) {
    return this.http.post(`${baseUrl}/ere/reportes/obtenerInformeResumen`, data);
  }

  obtenerInformeComparacion(data: any) {
    return this.http.post(`${baseUrl}/ere/reportes/obtenerInformeComparacion`, data);
  }
  ...
  exportarComparacionPdf(data: any) {
    return this.http.post(`${baseUrl}/ere/reportes/generarPdfComparacion`, data, {
      responseType: 'blob',
    });
  }

  exportarComparacionExcel(data: any) {
    return this.http.post(`${baseUrl}/ere/reportes/generarExcelComparacion`, data, {
      responseType: 'blob',
    });
  }

  importarResultados(data: any) {
    return this.http.post(`${baseUrl}/ere/reportes/importarResultados`, data);
  }
