...
export class EvaluacionExclusionesService {
  ...
  listarExclusiones(data: any) {
    return this.http.post(`${baseUrl}/ere/Evaluaciones/listarExclusiones`, data);
  }

  guardarExclusion(data: any) {
    return this.http.post(`${baseUrl}/ere/Evaluaciones/guardarExclusion`, data);
  }

  actualizarExclusion(data: any) {
    return this.http.post(`${baseUrl}/ere/Evaluaciones/actualizarExclusion`, data);
  }
  ...
  eliminarExclusion(data: any) {
    return this.http.post(`${baseUrl}/ere/Evaluaciones/eliminarExclusion`, data);
  }
