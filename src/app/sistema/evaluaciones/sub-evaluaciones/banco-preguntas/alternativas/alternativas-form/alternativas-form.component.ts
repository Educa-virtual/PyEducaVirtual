...
export class AlternativasFormComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.alternativaFormGroup.get('iPreguntaId').setValue(this.pregunta.iPreguntaId);
    ...
    if (this.alternativa != null) {
      ...
      this.alternativaFormGroup
        ...
        .setValue(this.alternativa.bAlternativaCorrecta == 1 ? true : false);
    } else {
      this.letrasDisponiblesPreguntaSeleccionada = filtrarPreguntasUsadas(letrasUsadas);
    }
  }
  ...
  obtenerNuevaAlternativas(alternativa) {
    ...
    alternativa.bAlternativaCorrecta = alternativa.bAlternativaCorrecta ? 1 : 0;
    ...
    if (existeAlternativa) {
      const index = newAlternativas.findIndex(x => x.iAlternativaId == alternativa.iAlternativaId);
