...
export class TicketService {
  ...
  async setCalendar(
    ...
    const id = (iCalAcadId || this.registroInformation.calendar?.iCalAcadId) ?? '';
    ...
    if (id) {
      ...
      data = await firstValueFrom(
        this.httpService.getData(`acad/calendarioAcademico/selCalAcademico?iCalAcadId=${id}`)
      );
      console.log(data);
      ...
      this.setTicketInformation(
        {
          ...
          matriculaInicio: new Date(data.data.dtCalAcadMatriculaInicio) ?? null,
          matriculaFin: new Date(data.data.dtCalAcadMatriculaFin) ?? null,
          matriculaResagados: new Date(data.data.dtCalAcadMatriculaResagados) ?? null,
          fases_promocionales: JSON.parse(data.data.fasesPromocionales) ?? null,
        },
        'stepYear'
      );
      ...
      this.setTicketInformation(
        {
          ...
          fechaInicio: new Date(fasesFechas.data.yearAcad.dtYAcadInicio),
  ...
  async insCalAcademico(
    ...
    try {
      const { iCalAcadId, iSedeId, iYAcadId } = this.registroInformation.calendar;

      const data = await firstValueFrom(
        this.httpService.postData('acad/calendarioAcademico/insCalAcademico', {
          json: JSON.stringify({
            iCalAcadId: iCalAcadId,
            iSedeId: iSedeId,
            iYAcadId: iYAcadId,
            dtCalAcadInicio: this.toSQLDatetimeFormat(calAcad.fechaInicio[0]) ?? null,
            dtCalAcadFin: this.toSQLDatetimeFormat(calAcad.fechaInicio[1]) ?? null,
            dtCalAcadMatriculaInicio:
              this.toSQLDatetimeFormat(calAcad.fechaMatriculaFin[0]) ?? null,
            dtCalAcadMatriculaFin: this.toSQLDatetimeFormat(calAcad.fechaMatriculaFin[1]) ?? null,
            dtCalAcadMatriculaResagados:
              this.toSQLDatetimeFormat(calAcad.fechaMatriculaRezagados[1]) ?? null,
  ...
  async updCalAcademico(
    ...
    try {
      ...
      await firstValueFrom(
        this.httpService.putData('acad/calendarioAcademico/updCalAcademico', {
          calAcad: JSON.stringify({
            iCalAcadId: iCalAcadId,
            dtCalAcadInicio: this.toSQLDatetimeFormat(calAcad.fechaInicio[0]),
            dtCalAcadFin: this.toSQLDatetimeFormat(calAcad.fechaInicio[1]),
            dtCalAcadMatriculaInicio: this.toSQLDatetimeFormat(calAcad.fechaMatriculaFin[0]),
            dtCalAcadMatriculaFin: this.toSQLDatetimeFormat(calAcad.fechaMatriculaFin[1]),
  ...
  async updReglamentoInterno(calAcad) {
    ...
    await firstValueFrom(
      this.httpService.putData('acad/institucionEducativa/updReglamentoInterno', formData)
    );
  }
  ...
  async updCalFasesProm(
    ...
    try {
      await firstValueFrom(
        this.httpService.putData('acad/calendarioAcademico/updCalFasesProm', {
  ...
  updCalFasesFechas({
    ...
    this.httpService.putData('acad/calendarioAcademico/updCalFasesFechas', {}).subscribe({
      next: () => {
        onNextCallbacks.forEach(callback => callback());
      },
  ...
  async insCalFasesProm(
    ...
    try {
      await firstValueFrom(
        this.httpService.postData('acad/calendarioAcademico/insCalFasesProm', {
  ...
  async deleteCalFasesProm(
    ...
    try {
      await firstValueFrom(
        this.httpService.deleteData('acad/calendarioAcademico/deleteCalFasesProm', {
  ...
  async selDias() {
    return await firstValueFrom(this.httpService.getData('acad/calendarioAcademico/selDias'));
  }
  ...
  async insCalDiasLaborales(dias) {
    ...
    await firstValueFrom(
      this.httpService.postData('acad/calendarioAcademico/insCalDiasLaborales', {
  ...
  async deleteCalDiasLaborales(dias) {
    ...
    await firstValueFrom(
      this.httpService.deleteData('acad/calendarioAcademico/deleteCalDiasLaborales', {
  ...
  async selTurnosModalidades() {
    return await firstValueFrom(
      this.httpService.getData('acad/calendarioAcademico/selTurnosModalidades')
    );
  }
  ...
  async insCalFormasAtencion(formaAtencion) {
    ...
    await firstValueFrom(
      this.httpService.postData('acad/calendarioAcademico/insCalFormasAtencion', {
        json: JSON.stringify({
          iTurnoId: formaAtencion.turno.iTurnoId,
          iModalServId: formaAtencion.modalidad.iModalServId,
          iCalAcadId: this.registroInformation.calendar.iCalAcadId,
          dtAperTurnoInicio: this.convertToSQLDateTime(formaAtencion.horaInicio),
          dtAperTurnoFin: this.convertToSQLDateTime(formaAtencion.horaFin),
        }),
      })
    );
  }
  ...
  async updFormasAtencion(formasAtencion) {
    await firstValueFrom(
      this.httpService.putData('acad/calendarioAcademico/updCalFormasAtencion', {
        json: JSON.stringify({
          iCalTurnoId: formasAtencion.id,
          iTurnoId: formasAtencion.turno.iTurnoId,
          iModalServId: formasAtencion.modalidad.iModalServId,
          iCalAcadId: this.registroInformation.calendar.iCalAcadId,
          dtAperTurnoInicio: this.convertToSQLDateTime(formasAtencion.horaInicio),
          dtAperTurnoFin: this.convertToSQLDateTime(formasAtencion.horaFin),
        }),
      })
    );
  }
  ...
  async deleteFormasAtencion(formasAtencion) {
    await firstValueFrom(
      this.httpService.deleteData('acad/calendarioAcademico/deleteCalFormasAtencion', {
        json: JSON.stringify({
  ...
  async selPeriodosFormativos() {
    return await firstValueFrom(
      this.httpService.getData('acad/calendarioAcademico/selPeriodosFormativos')
    );
  }
  ...
  async insPeriodosFormativos(periodosFormativos, fase, periodoType) {
    ...
    const periodos = periodosFormativos.map(periodo => ({
      ...
      dtPeriodoEvalAperInicio: this.toSQLDatetimeFormat(periodo.startDate),
      dtPeriodoEvalAperFin: this.toSQLDatetimeFormat(periodo.endDate),
    }));

    return await firstValueFrom(
      this.httpService.postData('acad/calendarioAcademico/insCalPeriodosFormativos', {
  ...
  async deleteCalPeriodosFormativos(periodos) {
    return await firstValueFrom(
      this.httpService.deleteData('acad/calendarioAcademico/deleteCalPeriodosFormativos', {
        json: JSON.stringify(
