...
export class TurnosComponent implements OnInit {
  ...
  async setFormasAtencion() {
    ...
    this.formasAtencionInformation = this.ticketService.registroInformation.stepFormasAtencion;
    ...
    const actions = {
      ...
      eliminar: async () => {
        ...
        await this.stepConfirmationService.confirmAction(
          {
            onAcceptPromises: [
              () => this.ticketService.deleteFormasAtencion(row.item),
  ...
  async indexColumns() {
    if (Array.isArray(this.ticketService.registroInformation.stepFormasAtencion)) {
  ...
  updateFormasAtencion() {
    ...
    const formasAtencion = this.ticketService.registroInformation.stepFormasAtencion.map(() => ({
