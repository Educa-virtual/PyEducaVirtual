...
export class ConfigFechasComponent implements OnInit {
  ...
  dateSpecialImport() {
    ...
    const dataImport = SheetToMatrix.getInstance('hojaDeDatosAImportar').setDataAccordingColumns();
      ...
      case 'editar':
        this.apiService.updateData({
          ...
          campos: {
            ...
            dtFechaImpFecha: this.utils.convertToSQLDateTime(this.form.value.dtFechaImpFecha),
            bFechaImpSeraLaborable: this.form.value.bFechaImpSeraLaborable,
