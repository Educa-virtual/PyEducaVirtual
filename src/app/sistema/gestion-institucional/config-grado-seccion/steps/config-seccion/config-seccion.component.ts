                    ...
                    .subscribe({
                        next: (data: any) => {
                            this.messageService.add({
                                ...
                                detail:
                                    'Se guardó correctamente la sección asignada. ' +
                                    data.data[0].id,
                            })
                        },
                        error: (error) => {
        ...
        this.query
            ...
            .subscribe({
                next: (data: any) => {
                    ...
                    const dias_json = JSON.parse(
                        dias_laborables[0].calDiasDatos
                    )
                ...
                error: (error) => {
                    ...
                    this.messageService.add({
                        ...
                        summary: 'Mensaje de sistema',
                        detail:
                            'Error al procesar dias calendarios:' +
                            error.message,
                    })
                },
                complete: () => {
    ...
    getSeccionesAsignadas() {
        this.query
            ...
            .subscribe({
                ...
                complete: () => {
                    this.stepService.secciones_asignadas =
