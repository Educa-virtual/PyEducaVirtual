...
export class ConfigComponent implements OnInit {
  ...
  getServicioAtencion() {
    ...
    if (Number(this.configuracion[0].iNivelTipoId) > 0) {
      ...
      this.query
        ...
        .subscribe({
          next: (data: any) => {
            ...
            this.form.controls['iServEdId'].setValue(this.serv_atencion[0].iServEdId);
      ...
      alert('Deben registrar el Tipo de de Nivel en los registros de la Institución Educatica');
    }
  }
