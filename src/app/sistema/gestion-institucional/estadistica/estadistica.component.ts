...
import { InformesEreComponent } from '../../ere/informes-ere/informes-ere/informes-ere.component';
...
@Component({
  ...
  imports: [CommonModule, FormsModule, PrimengModule, InformesEreComponent],
        ...
        this.GeneralService.getGralPrefix(params).subscribe({
          next: (response: any) => {
            if (response.validated) {
              this.identidad = this.identidad.filter(r => r.id !== registro.id);
              this.messageService.add({
                severity: 'success',
                summary: 'Eliminado',
