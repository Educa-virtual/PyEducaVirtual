...
export class ConfiguracionHorarioComponent implements OnInit {
    ...
    guardarHorario() {
        ...
        const confHorario = this.conf_bloques.find(
            (item) => item.iConfBloqueId === iConfBloqueId
        )
            ...
            .subscribe({
                ...
                error: (error) => {
                    this.messageService.add({
                        ...
                        summary: 'Mensaje del Sistema',
                        detail:
                            'Error al procesar la peticion:: ' + error.message,
                    })
                },
                complete: () => {
                    this.messageService.add({
            ...
            .subscribe({
                ...
                complete: () => {
                    this.horario_ies = this.horario_ies.map((item) => ({
                        ...item,
                        tHoraInicio: item.tHoraInicio
                            ? String(item.tHoraInicio)
                            : '',
