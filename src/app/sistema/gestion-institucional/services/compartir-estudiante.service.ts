...
export class CompartirEstudianteService {
  ...
  getActiveIndex(): string | null {
    if (!this.activeIndex) {
      this.activeIndex =
        localStorage.getItem('activeIndex') == 'null' ? null : localStorage.getItem('activeIndex');
    }
  ...
  getiPersId(): string | null {
    if (!this.iPersId) {
      this.iPersId =
        localStorage.getItem('iPersId') == 'null' ? null : localStorage.getItem('iPersId');
    }
    return this.iPersId;
  }
  ...
  getcEstCodigo(): string | null {
    if (!this.cEstCodigo) {
      this.cEstCodigo =
        localStorage.getItem('cEstCodigo') == 'null' ? null : localStorage.getItem('cEstCodigo');
    }
  ...
  getcEstApenom(): string | null {
    if (!this.cEstApenom) {
      this.cEstApenom =
        localStorage.getItem('cEstApenom') == 'null' ? null : localStorage.getItem('cEstApenom');
    }
  ...
  getiFamiliarId(): string | null {
    if (!this.iFamiliarId) {
      this.iFamiliarId =
        localStorage.getItem('iFamiliarId') == 'null' ? null : localStorage.getItem('iFamiliarId');
    }
