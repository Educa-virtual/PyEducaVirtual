...
export class DatosSugerenciaService {
  ...
  buscarSugerencias(data: any) {
    return this.http.post(`${baseUrl}/acad/estudiante/buscarSugerencias`, data);
  }
  ...
  buscarSugerencia(data: any) {
    return this.http.post(`${baseUrl}/acad/estudiante/buscarSugerencia`, data);
  }
  ...
  guardarSugerencia(data: any) {
    return this.http.post(`${baseUrl}/acad/estudiante/guardarSugerencia`, data);
  }
  ...
  actualizarSugerencia(data: any) {
    return this.http.put(`${baseUrl}/acad/estudiante/actualizarSugerencia`, data);
  }
  ...
  eliminarSugerencia(data: any) {
    return this.http.delete(`${baseUrl}/acad/estudiante/eliminarSugerencia`, data);
  }
