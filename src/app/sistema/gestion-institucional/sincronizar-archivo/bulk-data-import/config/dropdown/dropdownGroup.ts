    ...
    options: [
      {
        ...
        value: {
          ...
          importEndPoint: 'acad/estudiante/importarEstudiantesMatriculasExcel',
          params: {
            tipo: 'matriculas',
            iSedeId: JSON.parse(localStorage.getItem('dremoPerfil') || '{}').iSedeId,
            iYAcadId: JSON.parse(localStorage.getItem('dremoiYAcadId') || 'null'),
      ...
      },
      {
        ...
        value: {
          ...
          cellData: 'B15',
          columnsResultImport: resultEstudianteTemplateSiagieColumns,
          importEndPoint: 'acad/estudiante/importarEstudiantesPadresExcel',
          params: {
            iSedeId: JSON.parse(localStorage.getItem('dremoPerfil') || '{}').iSedeId,
            iYAcadId: JSON.parse(localStorage.getItem('dremoiYAcadId') || 'null'),
            iCredId: JSON.parse(localStorage.getItem('dremoPerfil') || '{}').iCredId,
    ...
    options: [
      {
        ...
        value: {
          ...
          importEndPoint: 'acad/gestionInstitucional/importarDocente_IE',
      ...
      },
      {
        ...
        value: {
          ...
          importEndPoint: 'acad/gestionInstitucional/importarAmbiente_IE',
          typeSend: 'json',
          params: {
            iSedeId: JSON.parse(localStorage.getItem('dremoPerfil') || '{}').iSedeId,
            iYAcadId: JSON.parse(localStorage.getItem('dremoiYAcadId') || 'null'),
            iNivelTipoId: JSON.parse(localStorage.getItem('dremoPerfil') || 'null').iNivelTipoId,
          },
          // payload: (data) => {
          //     return data.map(row => {
