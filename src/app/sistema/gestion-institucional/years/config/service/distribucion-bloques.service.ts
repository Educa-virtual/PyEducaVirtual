...
export class DistribucionBloquesService {
  ...
  getDistribucionBloques(iYearId?, iDistribucionBloqueId?) {
    ...
    return this.http.get(`${this.endPoint}/getDistribucionBloques/${iYearId}`);
  }
  ...
  deleteDistribucionBloque(iDistribucionBloqueId) {
    return this.http.delete(`${this.endPoint}/deleteDistribucionBloques/${iDistribucionBloqueId}`);
  }
}
